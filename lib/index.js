...
tollan.app.use(tollan.config.apiPrefix+'/action', actionRoutes);
tollan.app.use(tollan.config.apiPrefix+'/model', modelRoutes);
tollan.app.use(tollan.config.apiPrefix, api);
